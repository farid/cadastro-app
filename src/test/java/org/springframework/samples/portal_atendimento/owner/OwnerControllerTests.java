...
class OwnerControllerTests {
	...
	void setup() {
		...
		george.setCpf("01010010102");
		george.setEndereco("110 W. Liberty St.");
		george.setCep("87878786");
		george.setTelefone("6085551023");
		Pet max = new Pet();
	...
	void testProcessFindFormByLastName() throws Exception {
		given(this.owners.findByLastName(george.getNome())).willReturn(Lists.newArrayList(george));
