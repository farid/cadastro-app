...
class PetControllerTests {
	 ...
	 *
	 * // @MockBean private PetRepository pets;
	 *
	 ...
	 * .andExpect(view().name("pets/createOrUpdatePetForm")).andExpect(model().
	 * attributeExists("pet")); }
	 *
	 ...
	 * .andExpect(model().attributeHasErrors("pet")).andExpect(model().
	 * attributeHasFieldErrors("pet", "type"))
	 ...
	 * TEST_PET_ID)) .andExpect(status().isOk()).andExpect(model().attributeExists("pet"))
	 * .andExpect(view().name("pets/createOrUpdatePetForm")); }
	 *
